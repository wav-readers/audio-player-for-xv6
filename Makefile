...
CFLAGS = -Wall -Werror -O -fno-omit-frame-pointer -ggdb #thss:-Wall -O -fno-omit-frame-pointer -ggdb -Wno-error from"CFLAGS = -Wall -Werror -O -fno-omit-frame-pointer -ggdb"
CFLAGS += -MD
